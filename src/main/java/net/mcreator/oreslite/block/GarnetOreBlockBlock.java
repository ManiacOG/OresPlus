...
public class GarnetOreBlockBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:garnet_ore_block")
	public static final Block block = null;
	public GarnetOreBlockBlock(OresliteModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("garnet_ore_block");
		}
