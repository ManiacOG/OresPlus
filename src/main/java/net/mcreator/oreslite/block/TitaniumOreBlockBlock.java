...
public class TitaniumOreBlockBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:titanium_ore_block")
	public static final Block block = null;
	public TitaniumOreBlockBlock(OresliteModElements instance) {
		super(instance, 32);
	}
