...
public class DiopsideOreBlockBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:diopside_ore_block")
	public static final Block block = null;
	public DiopsideOreBlockBlock(OresliteModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("diopside_ore_block");
		}
