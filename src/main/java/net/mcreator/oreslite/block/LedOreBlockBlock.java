...
public class LedOreBlockBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:led_ore_block")
	public static final Block block = null;
	public LedOreBlockBlock(OresliteModElements instance) {
		super(instance, 9);
	}
