...
public class SilverOreBlockBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:silver_ore_block")
	public static final Block block = null;
	public SilverOreBlockBlock(OresliteModElements instance) {
		super(instance, 194);
	}
