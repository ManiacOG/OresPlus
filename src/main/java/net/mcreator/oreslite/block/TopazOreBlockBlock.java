...
public class TopazOreBlockBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:topaz_ore_block")
	public static final Block block = null;
	public TopazOreBlockBlock(OresliteModElements instance) {
		super(instance, 95);
	}
