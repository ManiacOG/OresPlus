...
import net.mcreator.oreslite.item.ZincIngotItem;
...
public class ZincOreBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:zinc_ore")
	public static final Block block = null;
	public ZincOreBlock(OresliteModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ZincIngotItem.block, (int) (1)));
		}
	}
	@Override
