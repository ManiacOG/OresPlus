...
import net.mcreator.oreslite.item.DiopsideGemItem;
...
public class DiopsideOreBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:diopside_ore")
	public static final Block block = null;
	public DiopsideOreBlock(OresliteModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DiopsideGemItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("diopside_ore", "diopside_ore", blockAt -> {
