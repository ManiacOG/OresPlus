...
import net.mcreator.oreslite.item.TopazGemItem;
...
public class TopazOreBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:topaz_ore")
	public static final Block block = null;
	public TopazOreBlock(OresliteModElements instance) {
		super(instance, 94);
	}
