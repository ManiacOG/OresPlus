...
import net.mcreator.oreslite.item.SilverIngotItem;
...
public class SilverOreBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(OresliteModElements instance) {
		super(instance, 193);
	}
