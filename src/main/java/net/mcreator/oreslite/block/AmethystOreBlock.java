...
import net.mcreator.oreslite.item.AmethystGemItem;
...
public class AmethystOreBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:amethyst_ore")
	public static final Block block = null;
	public AmethystOreBlock(OresliteModElements instance) {
		super(instance, 136);
	}
