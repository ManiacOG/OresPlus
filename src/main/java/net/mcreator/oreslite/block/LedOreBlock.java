...
import net.mcreator.oreslite.item.LedIngotItem;
...
public class LedOreBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:led_ore")
	public static final Block block = null;
	public LedOreBlock(OresliteModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LedIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("led_ore", "led_ore", blockAt -> {
