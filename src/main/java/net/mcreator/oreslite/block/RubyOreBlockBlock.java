...
public class RubyOreBlockBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:ruby_ore_block")
	public static final Block block = null;
	public RubyOreBlockBlock(OresliteModElements instance) {
		super(instance, 116);
	}
