...
import net.mcreator.oreslite.item.RubyGemItem;
...
public class RubyOreBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(OresliteModElements instance) {
		super(instance, 115);
	}
