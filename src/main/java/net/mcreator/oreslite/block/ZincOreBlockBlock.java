...
public class ZincOreBlockBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:zinc_ore_block")
	public static final Block block = null;
	public ZincOreBlockBlock(OresliteModElements instance) {
		super(instance, 3);
	}
