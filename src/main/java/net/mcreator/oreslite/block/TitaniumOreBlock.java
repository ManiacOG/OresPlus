...
import net.mcreator.oreslite.item.TitaniumGemItem;
...
public class TitaniumOreBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:titanium_ore")
	public static final Block block = null;
	public TitaniumOreBlock(OresliteModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TitaniumGemItem.block, (int) (1)));
		}
	}
	@Override
