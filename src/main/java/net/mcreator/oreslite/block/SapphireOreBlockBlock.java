...
public class SapphireOreBlockBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:sapphire_ore_block")
	public static final Block block = null;
	public SapphireOreBlockBlock(OresliteModElements instance) {
		super(instance, 158);
	}
