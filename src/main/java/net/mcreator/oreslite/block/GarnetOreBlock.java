...
import net.mcreator.oreslite.item.GarnetGemItem;
...
public class GarnetOreBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:garnet_ore")
	public static final Block block = null;
	public GarnetOreBlock(OresliteModElements instance) {
		super(instance, 52);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GarnetGemItem.block, (int) (1)));
		}
	}
	@Override
