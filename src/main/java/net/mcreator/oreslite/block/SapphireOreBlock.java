...
import net.mcreator.oreslite.item.SapphireGemItem;
...
public class SapphireOreBlock extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:sapphire_ore")
	public static final Block block = null;
	public SapphireOreBlock(OresliteModElements instance) {
		super(instance, 157);
	}
