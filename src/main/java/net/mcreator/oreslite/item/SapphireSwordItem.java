...
public class SapphireSwordItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:sapphire_sword")
	public static final Item block = null;
	public SapphireSwordItem(OresliteModElements instance) {
		super(instance, 164);
	}
