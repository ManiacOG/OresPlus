...
public class LedHoeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:led_hoe")
	public static final Item block = null;
	public LedHoeItem(OresliteModElements instance) {
		super(instance, 17);
	}
