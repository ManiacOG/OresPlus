...
public class DiopsideHoeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:diopside_hoe")
	public static final Item block = null;
	public DiopsideHoeItem(OresliteModElements instance) {
		super(instance, 82);
	}
