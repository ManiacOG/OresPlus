...
public class AmethystShovelItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:amethyst_shovel")
	public static final Item block = null;
	public AmethystShovelItem(OresliteModElements instance) {
		super(instance, 144);
	}
