...
public class ObsidianAxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:obsidian_axe")
	public static final Item block = null;
	public ObsidianAxeItem(OresliteModElements instance) {
		super(instance, 178);
	}
