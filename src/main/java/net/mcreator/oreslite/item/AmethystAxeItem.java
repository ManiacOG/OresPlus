...
public class AmethystAxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:amethyst_axe")
	public static final Item block = null;
	public AmethystAxeItem(OresliteModElements instance) {
		super(instance, 142);
	}
