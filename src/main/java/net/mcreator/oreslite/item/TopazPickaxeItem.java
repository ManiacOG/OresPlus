...
public class TopazPickaxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:topaz_pickaxe")
	public static final Item block = null;
	public TopazPickaxeItem(OresliteModElements instance) {
		super(instance, 99);
	}
