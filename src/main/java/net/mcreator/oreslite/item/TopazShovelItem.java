...
public class TopazShovelItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:topaz_shovel")
	public static final Item block = null;
	public TopazShovelItem(OresliteModElements instance) {
		super(instance, 102);
	}
