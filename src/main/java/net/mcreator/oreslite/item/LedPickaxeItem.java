...
public class LedPickaxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:led_pickaxe")
	public static final Item block = null;
	public LedPickaxeItem(OresliteModElements instance) {
		super(instance, 13);
	}
