...
public class TopazArmorItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:topaz_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("oreslite:topaz_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("oreslite:topaz_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("oreslite:topaz_armor_boots")
	public static final Item boots = null;
	public TopazArmorItem(OresliteModElements instance) {
		super(instance, 109);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(OresLiteItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "oreslite:textures/models/armor/topaz_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
