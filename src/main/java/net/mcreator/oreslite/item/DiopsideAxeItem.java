...
public class DiopsideAxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:diopside_axe")
	public static final Item block = null;
	public DiopsideAxeItem(OresliteModElements instance) {
		super(instance, 79);
	}
