...
public class GarnetHoeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:garnet_hoe")
	public static final Item block = null;
	public GarnetHoeItem(OresliteModElements instance) {
		super(instance, 61);
	}
