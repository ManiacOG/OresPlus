...
public class GarnetPickaxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:garnet_pickaxe")
	public static final Item block = null;
	public GarnetPickaxeItem(OresliteModElements instance) {
		super(instance, 57);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("garnet_pickaxe"));
	}
}
