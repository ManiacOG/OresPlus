...
public class LedIngotItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:led_ingot")
	public static final Item block = null;
	public LedIngotItem(OresliteModElements instance) {
		super(instance, 7);
	}
