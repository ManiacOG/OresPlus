...
public class AmethystPickaxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:amethyst_pickaxe")
	public static final Item block = null;
	public AmethystPickaxeItem(OresliteModElements instance) {
		super(instance, 141);
	}
