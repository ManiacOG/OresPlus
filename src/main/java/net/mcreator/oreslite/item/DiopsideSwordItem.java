...
public class DiopsideSwordItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:diopside_sword")
	public static final Item block = null;
	public DiopsideSwordItem(OresliteModElements instance) {
		super(instance, 80);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("diopside_sword"));
	}
}
