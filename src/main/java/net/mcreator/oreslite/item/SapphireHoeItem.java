...
public class SapphireHoeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:sapphire_hoe")
	public static final Item block = null;
	public SapphireHoeItem(OresliteModElements instance) {
		super(instance, 166);
	}
