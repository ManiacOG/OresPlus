...
public class LedAxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:led_axe")
	public static final Item block = null;
	public LedAxeItem(OresliteModElements instance) {
		super(instance, 14);
	}
