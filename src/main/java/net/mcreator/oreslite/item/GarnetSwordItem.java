...
public class GarnetSwordItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:garnet_sword")
	public static final Item block = null;
	public GarnetSwordItem(OresliteModElements instance) {
		super(instance, 59);
	}
