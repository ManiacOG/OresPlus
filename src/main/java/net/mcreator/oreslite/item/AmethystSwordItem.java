...
public class AmethystSwordItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:amethyst_sword")
	public static final Item block = null;
	public AmethystSwordItem(OresliteModElements instance) {
		super(instance, 143);
	}
