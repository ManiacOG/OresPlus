...
public class SapphirePickaxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:sapphire_pickaxe")
	public static final Item block = null;
	public SapphirePickaxeItem(OresliteModElements instance) {
		super(instance, 162);
	}
