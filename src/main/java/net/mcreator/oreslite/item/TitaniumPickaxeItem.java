...
public class TitaniumPickaxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:titanium_pickaxe")
	public static final Item block = null;
	public TitaniumPickaxeItem(OresliteModElements instance) {
		super(instance, 36);
	}
