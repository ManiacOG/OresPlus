...
public class AmethystHoeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:amethyst_hoe")
	public static final Item block = null;
	public AmethystHoeItem(OresliteModElements instance) {
		super(instance, 145);
	}
