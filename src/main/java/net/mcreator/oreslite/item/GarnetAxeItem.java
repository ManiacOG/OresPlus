...
public class GarnetAxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:garnet_axe")
	public static final Item block = null;
	public GarnetAxeItem(OresliteModElements instance) {
		super(instance, 58);
	}
