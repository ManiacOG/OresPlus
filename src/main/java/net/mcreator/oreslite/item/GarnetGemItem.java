...
public class GarnetGemItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:garnet_gem")
	public static final Item block = null;
	public GarnetGemItem(OresliteModElements instance) {
		super(instance, 51);
	}
