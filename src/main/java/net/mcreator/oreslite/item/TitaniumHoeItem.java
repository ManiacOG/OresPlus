...
public class TitaniumHoeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:titanium_hoe")
	public static final Item block = null;
	public TitaniumHoeItem(OresliteModElements instance) {
		super(instance, 40);
	}
