...
public class RubyPickaxeItem extends OresliteModElements.ModElement {
	@ObjectHolder("oreslite:ruby_pickaxe")
	public static final Item block = null;
	public RubyPickaxeItem(OresliteModElements instance) {
		super(instance, 120);
	}
